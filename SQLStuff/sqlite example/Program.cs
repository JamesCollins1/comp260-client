...
namespace Server
{
    ...
    class Program
    {
        ...
        static string databaseName = "ExcellentNameForDatabase.Database";
        ...
        static void Main(string[] args)
        {
            ...
            catch (Exception ex)
            {
                ...
                command = new sqliteCommand("create table table_dun (roomname varchar(20), number int )", conn);
            ...
            while (!bQuit)
            {
                ...
                lock (playerDictionary)
                {
                    ...
                    Player newPlayer = new Player(GetNameFromSocket(serverClient));
                ...
                myDungeon.StartRoom.HasbeenHere = true;
            }
        }
    }
}
