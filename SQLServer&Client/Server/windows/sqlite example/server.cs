    ...
    class server
    {
                ...
                try
                {
                    ...
                    if (result > 0)
                    {
                        ...
                        lock (incommingMessages)
                        {
                            ...
                            {
                                MyDungeon.Process(receiveInfo.clientCharacter, message, receiveInfo.socket, socketToCharacter, connection);
                            }
                            MyDungeon.RoomInfo(receiveInfo.socket,connection, socketToCharacter);
                        }
                    }
        ...
        static void Main(string[] args)
        {
            ...
            catch (Exception ex)
            {
                ...
                command = new sqliteCommand("create table table_dungeon (name varchar(20), description varchar(200), north varchar(20), south varchar(20), east varchar(20), west varchar(20))", connection);
